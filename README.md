...
- add per-user settings instead of a global settings document
- show recommendation scores in the UI
- add pagination or filtering for recommendations
- log evaluation metrics such as click-through rate and solve rate
